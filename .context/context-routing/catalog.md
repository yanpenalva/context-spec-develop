...
| `testing` | Code-quality standards, configured quality tools, testing and validation requirements and evidence rules | `.context/policies/core/code-quality.md`, `.context/policies/core/testing.md`, `.context/project/testing.md`, `.context/project/quality.md` | Planning or executing code; planning validation strategy; entering verify; reviewing code, test or quality evidence; task concerns tests |
